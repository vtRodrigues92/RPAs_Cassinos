            ...
            try:
                ...
                try:
                    with open("api.txt","r") as arquivo:
                        url_spaceman = arquivo.readlines()
                        session = requests.session()
                        response = session.get(url_spaceman[0])
                        historico_velas = json.loads(response.content)

                        lista_resultados = []
                        for vela in historico_velas["history"][:25]:
                    ...
                    print('ERRO AO PEGAR HISTORICO DE RESULTADOS --- NOVA TENTATIVA EM ALGUNS INSTANTES')
                    time.sleep(30)
                    continue
                ...
                validar_estrategia(lista_resultados, estrategias, session)   #Lista de estrategia
...
def validar_estrategia(lista_resultados, estrategias, session):
    global gale
    global vela_atual
...
def registrar_cash_out(message_tipo_cash_out):
    ...
    if message_tipo_cash_out.text in ['CASH OUT 5X']:
        ...
        estrategias_padroes = (['-9.9','-9.9','-9.9','-9.9','-9.9','-9.9','-9.9','-9.9','-9.9','-9.9','-9.9','-9.9','-9.9','-9.9','-9.9','-9.9','-9.9','-9.9','-9.9','-9.9','-9.9','-9.9','-9.9','5x','9'], 
                               ['+15','-4','-4','-4','-4','-4','5x','9'], 
                               ['+20','-5','-5','-5','-5','-5','5x','9'])
