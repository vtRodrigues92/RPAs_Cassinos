...
print()
print('                                #################################################################')
print('                                ###########  BOT DADOS PARA ROLETAS EVOLUTION  ##################')
print('                                #################################################################')
...
class enviarDadosBanco(threading.Thread):
    ...
    def run(self):
        ...
        TABELA = 'results_lobby_evolution'
...
def formatar_resultados_evolution(roleta):  
    ...
    try:
        ...
        for numero in resultados:
            ...
            elif 'VIP' in numero or 'Novo' in numero or 'Russian Roulette' in numero:
                continue
...
def logarSite():
    ...
    while True:
        try:
            ...
            #time.sleep(2)
            browser.find_element_by_name('email').send_keys('Pedro.cletoooo@gmail.com') 
            time.sleep(2)
            #Inserindo senha
    ...
    #Acessando a roleta da Evolution
    browser.get('https://www.arbety.com/games/external/5564f22a260c4e8daa807eed6e68d065')
    time.sleep(10)

    #Acessando iframe da roleta Evolution
    c=0
    while c < 10:
        try:
...
def coletarResultados():
    ...
    elemento_roletas = '//*[@class="GridListItem--052ed"]'
    ...
    while True:
        ...
        try:
            ...
            if roletas == []:
                print('classe das roletas retornou vazio.')
                logarSite()
                continue
            ...
            for roleta in roletas:
                ...
                if nome_cassino == 'Double Ball Roulette':
                    continue
