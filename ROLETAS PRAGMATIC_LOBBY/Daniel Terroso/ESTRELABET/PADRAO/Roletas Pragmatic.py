...
def link_roletas(nome_roleta):
    ...
    roletas_e_links = [
        ...
        ('Mega Roleta','https://estrelabet.com/pb/gameplay/mega-roulette/real-game'),
        ('Roleta Azure','https://estrelabet.com/pb/gameplay/roulette-azure/real-game'),
        ('PowerUP Roleta','https://estrelabet.com/pb/gameplay/powerup-roulette/real-game'),
        ('Roleta Ruby','https://estrelabet.com/pb/gameplay/roulette-10-ruby/real-game'),
        ('Autorroleta','https://estrelabet.com/pb/gameplay/auto-roulette/real-game'),
        ('Roleta Verde','https://estrelabet.com/pb/gameplay/pp201/1/pragmaticplay/real-game'),
        ('Autorroleta Rápida','https://estrelabet.com/pb/gameplay/speed-auto-roulette/real-game'),
        ('Roleta Macau','https://estrelabet.com/pb/gameplay/roulette-macao/real-game'),
        ('Roleta Russa','https://estrelabet.com/pb/gameplay/roulette-russia/real-game'),
        ('Roleta Rápida 2','https://estrelabet.com/pb/gameplay/speed-roulette-2/real-game')
