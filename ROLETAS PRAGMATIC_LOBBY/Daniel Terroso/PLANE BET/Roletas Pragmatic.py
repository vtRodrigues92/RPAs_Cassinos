...
def link_roletas(nome_roleta):
    ...
    roletas_e_links = [
        ...
        ('Mega Roulette','https://www.plane.bet/casino/lobby/live/providers/312/game/9681?demo=false'),
        ('Roleta 1 - Azure','https://www.plane.bet/casino/lobby/live/providers/312/game/9681?demo=false'),
        ('PowerUP Roleta','https://www.plane.bet/casino/lobby/live/providers/312/game/9681?demo=false'),
        ('Roleta Rápida 1','https://www.plane.bet/casino/lobby/live/providers/312/game/9681?demo=false'),
        ('Autorroleta 1','https://www.plane.bet/casino/lobby/live/providers/312/game/9681?demo=false'),
        ('Roleta 2',''),
        ('Roleta 3 - Macau',''),
        ('Roleta Rápida 2','https://www.plane.bet/casino/lobby/live/providers/312/game/9681?demo=false'),
        ('Roleta 4 - Russo','https://www.plane.bet/casino/lobby/live/providers/312/game/9681?demo=false'),
        ('Roleta 5 - Alemão','https://www.plane.bet/casino/lobby/live/providers/312/game/9681?demo=false')
...
def logarSite():
    ...
    while True:
        try:
            browser.find_element_by_id('btn_login_dialog').click()
            time.sleep(5)
            browser.find_elements_by_xpath('//*[@class="v-text-field__slot"]//*[name()="input"][@icon="person"]')[0].send_keys(usuario) 
            #Inserindo senha
            browser.find_elements_by_xpath('//*[@class="v-text-field__slot"]//*[name()="input"][@icon="mdi-lock"]')[0].send_keys(senha) 
    ...
    try:
        ...
        browser.get('https://www.plane.bet/casino/lobby/live/category/Roletas%20(Ao%20vivo)/game/9404?demo=false')  
        time.sleep(10)
