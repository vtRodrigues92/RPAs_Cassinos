...
def auto_refresh():
    ...
    tres_hora = timedelta(minutes=15)
...
def envia_placar():
    ...
    try:
        ...
        =====================\n\
        ✅ Vitória - "+str(placar_win)+"\n\
        ✔️ Sem Gale - "+str(placar_semGale)+"\n\
        🐔 Um Gale - "+str(placar_gale1)+"\n\
        🐔🐔 Dois Gale - "+str(placar_gale2)+"\n\
        ❌ Derrota - "+str(placar_loss)+"\n\
        =====================\n\
...
def logarSite():
    ...
    browser.get('https://rgs-livedealerwebclient.playpix.com/pb/18750115/105')
...
def coletarResultados(lista_roletas):
    ...
    while True:
        ...
        try:
            ...
            #COLETANDO INFORMAÇÕES
            #Historico de resultados da Roleta
            historico_roleta = formatar_resultados(browser.find_elements_by_xpath('//*[@class="mini-statistics"]')[0]) # Formata o historico em lista
            
            #Nome do Cassino
            try:
                nome_cassino = 'Roulette A'
            except:
                pass
            ...
            validarEstrategia(dicionario_roletas, nome_cassino, lista_estrategias)
            print('=' * 150)
...
def validarEstrategia(dicionario_roletas, nome_cassino, lista_estrategias):
    global estrategia
    global contador_passagem
            ...
            if validador.count('true') == int(sequencia_minima)-1:
                ...
                while True:
                    try:
                        ...
                        lista_proximo_resultados = formatar_resultados(browser.find_elements_by_xpath('//*[@class="mini-statistics"]')[0]) # Formata o historico em lista
...
def checkSinalEnviado(lista_proximo_resultados, nome_cassino):
    ...
    while contador_cash <= 2:
        ...
        try:
            ...
            lista_resultados_sinal = formatar_resultados(browser.find_elements_by_xpath('//*[@class="mini-statistics"]')[0]) # Formata o historico em lista
            ...
            logger.error('Exception ocorrido no ' + repr(a))
            #logarSite()
            lista_resultados_sinal = formatar_resultados(browser.find_elements_by_xpath('//*[@class="mini-statistics"]')[0])
            continue
...
def ultimosResultados(message):
    ...
    if botStatus == 0 and dicionario_roletas == {}:
        ...
        markup = markup.add('/start','✅ Ativar Bot','⚙🧠 Cadastrar Estratégia', '🧠📜 Estratégias Cadastradas', '🗑🧠 Apagar Estratégia', '📊 Placar Atual','📈 Gestão','🛑 Pausar Bot')
