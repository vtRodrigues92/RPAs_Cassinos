        ...
        try:
            ...
            for roleta in roletas:
                ...
                try:
                    ...
                    link_roleta = 'https://m.dupoc.com/pb/casino/game-view/400040781'
                ...
                if nome_cassino == 'Roulette BRASILEIRA':
                    pass
                else:
                    continue
...
def start(message):
    ...
    if str(message.chat.id) in ids:
        ...
        message_opcoes = bot.reply_to(message, "🤖 Bot de Roletas CREEDROOMZ Iniciado! ✅ Escolha uma opção 👇",
                                    reply_markup=markup)
