...
def pegar_token_websocket():
    ...
    headersLogin = {"Content-Type": "application/json",
                    "Finger_print":"4548ca8d7af388d9d613051d4afeeee5",
    ...
    payloadEvo = '{"requestBody":{"gameId":"22968",\
                    "channel":"mobile",\
                    "vendorId":10536,\
                    "redirectUrl":"https://m.estrelabet.com/ptb/games/detail/casino/normal/22968"},\
                    "identity":null,\
                    "device":"m",\
                    "languageId":23}'
...
def conectar_websocket(token):
    ...
    "Connection": "Upgrade",
    "Host": "nodeprod-01.globalgames.io:32000",
    "Origin": "https://gg-production.globalgames.io",
    "Pragma": "no-cache",
    "Sec-WebSocket-Extensions": "permessage-deflate; client_max_window_bits",
    "Sec-WebSocket-Key": "+RKMsg+P6LrGbTrxIdqckw==",
    ...
    URL = f'wss://nodeprod-01.globalgames.io:32000/connect/?token={token}'
...
def start(message):
    ...
    if str(message.chat.id) in ids:
        ...
        message_opcoes = bot.reply_to(message, "🤖 Bot Moto Grau Iniciado! ✅ Escolha uma opção 👇",
                                reply_markup=markup)
