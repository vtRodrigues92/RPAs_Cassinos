...
def conectar_websocket(evosessionid):
    ...
    URL=f'wss://nesvembataross.evo-games.com/public/topcard/player/game/TopCard000000001/socket?messageFormat=json&instance=198nq3-rgzgfgbvkiodg5an-TopCard000000001&tableConfig=&EVOSESSIONID={evosessionid}&client_version=6.20230727.71828.28476-cda9afe7b7'
        ...
        for key, value in canais.items():
            try:
                ...
                table_sinal =\
                            ...
                            mensagem_sinal[20].replace('\n','').replace('[SITE_PC]',value[1]).replace('[SITE_MB]',value[2])              
                    ...
                    try:
                        ...
                        for key, value in canais.items():
                            try:
                                ...
                                responderMensagemTelegram(key, mensagem_green[27].replace('\n','').replace('[RESULTADO]', ' | '.join(resultado_valida_sinal))).start()
                                time.sleep(0.1)
