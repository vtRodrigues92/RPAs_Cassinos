...
def conectar_websocket(evosessionid):
    ...
    "Connection": "Upgrade",
    "Cookie":f"EVOSESSIONID={evosessionid}; cdn=https://static.egcdn.com; lang=pt; locale=pt-BR",
    ...
    URL=f'wss://belloatech.evo-games.com/public/topcard/player/game/TopCard000000001/socket?messageFormat=json&instance=y1ogbh-rhjuf7mokioplhho-TopCard000000001&tableConfig=&EVOSESSIONID={evosessionid}&client_version=6.20231217.210359.36178-ee689a66ae'
