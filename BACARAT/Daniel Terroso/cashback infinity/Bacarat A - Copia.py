...
def pegar_evosessionid():
    ...
    while True:
        ...
        try:
            ...
            payload = {"email":"erickqueirozstreamer@gmail.com",
                    "password":"Paty!2#"}
            ...
            print(token_autorizacao)    

            #### ENTRANDO NO GAME
            #REQUISIÇÃO1
            URL = 'https://arbety.eway.dev:3000/api/sports/login'

            payload = {"game_id": "d28a9243b2c34f44a740aeff16d4a262"}
...
def conectar_websocket(evosessionid):
    ...
    try:
        ...
        "Sec-WebSocket-Key": "H2S2GcthC1KTsUBqP5yEJQ==",
        ...
        URL = f'wss://tmkybox.evo-games.com/public/baccarat/player/game/oytmvb9m1zysmc44/socket?messageFormat=json&instance=si9r6j-r3xjdarbgaqrrchd-oytmvb9m1zysmc44&tableConfig=&{evosessionid}&client_version=6.20240416.72115.41138-f82efd7156'
...
def enviarSinalTelegram():
    ...
    try:
        ...
        texto = message_sinal\
                    .replace('[COR]', ' 🟥 🟥 🟦 🟦' if estrategia[-1] == 'alternadoDuploB' else ' 🟦 🟦 🟥 🟥 ' if estrategia[-1] == 'alternadoDuploP' else '🟩' )\
...
def checkSinalEnviado(lista_resultados_validacao):
    ...
    global placar_maior
    global inicio_alternado, contador_alternado

    resultado_valida_sinal = []
    contador_cash = 0
    contador_alternado = 0
    

    if estrategia[-1] == 'alternadoDuploB':
        resultado_estrategia = 'B'
        inicio_alternado = 'B'
    elif estrategia[-1] == 'alternadoDuploP':
...
def estrategia_alterada(inicio_alternado):
    global contador_alternado

    try:

        if inicio_alternado == 'B' and contador_alternado == 1:
            inicio_alternado = 'P'
            contador_alternado = 0
        
        elif inicio_alternado == 'P' and contador_alternado == 1:
            inicio_alternado = 'B'
            contador_alternado = 0

        elif inicio_alternado == 'B' and contador_alternado == 0:
            contador_alternado +=1
        
        elif inicio_alternado == 'P' and contador_alternado == 0:
            contador_alternado +=1
...
def registrarTipoEstrategia(message_tipo_estrategia):
    ...
    if message_tipo_estrategia.text in ['ESTRATÉGIAS PADRÕES']:
        ...
        estrategias_padroes = ( 
                                ['P','P','alternadoDuploP'],
                                ['B','B','alternadoDuploB'],
                                ['P','B','P','alternadoDuploB'],
                                ['B','P','B','alternadoDuploP'],
                              )
