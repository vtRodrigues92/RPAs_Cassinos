...
print()
print('                                #################################################################')
print('                                ##########       BOT NO COMISSION BACCARAT       ################')
print('                                #################################################################')
...
def pegar_evosessionid():
    ...
    while True:
        ...
        try:
            ...
            payload = {"email":"terrosowg@gmail.com",
                    "password":"10203040"}
...
def conectar_websocket(evosessionid):
    ...
    try:
        ...
        "Sec-WebSocket-Key": "h35IXnhUl2g1ZYVYn9IYBg==",
        ...
        URL = f'wss://tmkybox.evo-games.com/public/baccarat/player/game/oytmvb9m1zysmc44/socket?messageFormat=json&instance=4k1yqu-rvq7gghk7ajshdam-oytmvb9m1zysmc44&tableConfig=&{evosessionid}&client_version=6.20240221.72226.39103-c4a89d233b'
