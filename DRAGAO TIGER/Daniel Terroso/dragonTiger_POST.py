...
def pegar_evosessionid():
    ...
    payloadEvo = '{"requestBody":{"gameId":"18479","channel":"web","vendorLimitId":"evol_DragonTiger00001_BRL","vendorId":130,"redirectUrl":"https://vembetar.com/ptb/games/livecasino/detail/normal/18479/evol_DragonTiger00001_BRL"},"identity":null,"device":"d","languageId":23}'
...
def conectar_websocket(evosessionid):
    ...
    "Connection": "Upgrade",
    "Cookie":f"cdn=https://static.egcdn.com; lang=pt; locale=pt-BR; EVOSESSIONID={evosessionid}",
    "Host": "belloatech.evo-games.com",
    "Origin": "https://belloatech.evo-games.com",
    "Pragma": "no-cache",
    "Sec-WebSocket-Extensions": "permessage-deflate; client_max_window_bits",
    "Sec-WebSocket-Key": "FK84VBFaaYBjE52bQIGIbg==",
    ...
    #URL = f'wss://belloatech.evo-games.com/public/dragontiger/player/game/DragonTiger00001/socket?messageFormat=json&instance=ck5iib-rhh366qanhyf7qai-DragonTiger00001&tableConfig=&EVOSESSIONID={evosessionid}&client_version=6.20230804.72632.28942-740735c805'
    URL = f'wss://belloatech.evo-games.com/public/dragontiger/player/game/DragonTiger00001/socket?messageFormat=json&instance=tqy60q-rhjuf7mokioplhho-DragonTiger00001&tableConfig=&EVOSESSIONID={evosessionid}&client_version=6.20231217.210359.36178-ee689a66ae'
...
def logarSite():
    ...
    try:
        browser.find_element_by_css_selector('.button-login[data-v-742e4e55]').click() #Clicando no botão Entrar
    ...
    browser.get(r"https://pi.njoybingo.com/game.do?token=8fc038c6-5603-4242-ac36-f47a4eb4ccaa&pn=meskbet&lang=pt&game=EVOLUTION-dragontiger-DragonTiger00001&type=CHARGED")
    time.sleep(10)
    ...
    #''' Acessando jogo em tela cheia '''
    #while True:
    #    try:
    #        elemento_iframe = browser.find_element_by_xpath('//*[@id="__layout"]/main/div[3]/div/div/div/div/div[3]/div/iframe')
    #        tela_cheia = elemento_iframe.get_attribute('src')
    ...
    #https://pi.njoybingo.com/game.do?token=18298495-0dce-4997-944e-f52c78717619&pn=meskbet&lang=pt&game=EVOLUTION-dragontiger-DragonTiger00001&type=CHARGED
    #'https://pi.njoybingo.com/game.do?token=b22941c0-2c72-415e-9d21-5d57f6662a81&pn=meskbet&lang=pt&game=EVOLUTION-dragontiger-DragonTiger00001&type=FREE'
...
def enviar_sinal_telegram():
    ...
    try:
        ...
        texto =  mensagem_sinal[9].replace('\n','') + '\n' +\
                 mensagem_sinal[11].replace('\n','').replace('[COR]','🟨TIGER' if estrategia[-1] == 'Tiger' else '🟥DRAGON' if estrategia[-1] == 'Dragon' else '🟩TIER') + '\n' +\
                    ...
                    try:
                        ...
                        for key, value in canais.items():
                            try:
                                ...
                                responderMensagemTelegram(key, mensagem_green[22].replace('[RESULTADO]', ' | '.join(resultado_valida_sinal))).start()
                                time.sleep(0.1)
...
def registrarTipoEstrategia(message_tipo_estrategia):
    ...
    if message_tipo_estrategia.text in ['ESTRATÉGIAS PADRÕES']:
        ...
        estrategias_padroes = ( ['Dragon', 'Tiger', 'Dragon', 'Tiger', 'Dragon', 'Tiger', 'Tiger'],
                                ['Tiger', 'Dragon', 'Tiger', 'Dragon', 'Tiger', 'Dragon', 'Dragon'], 
                                ['Dragon', 'Dragon', 'Dragon', 'Dragon', 'Tiger'], 
                                ['Tiger', 'Tiger', 'Tiger', 'Tiger', 'Dragon']
                              )
