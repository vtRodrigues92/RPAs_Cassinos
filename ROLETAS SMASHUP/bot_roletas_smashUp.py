...
def resgatar_historico(roleta):
    ...
    try:
        ...
        roletas = browser.find_elements_by_xpath('//*[@id="category-grid-roulette"]/ul/*[name()="li"]/*[@id]/*[name()="article"]/div[2]/div[1]')
        historico_resultados = browser.find_elements_by_xpath('//*[@id="category-grid-roulette"]/ul/*[name()="li"]/*[@id]/*[name()="article"]/div[1]/div[2]')
        lista_resultados = []
...
def inicio():
    ...
    lobby_cassinos = 'https://player.smashup.com/player_center/goto_common_game/5941/1000000?_ga=2.224743059.868398848.1667587087-1708057999.1667587087'
...
def logarSite():
    ...
    try:
        if browser.find_elements_by_xpath('//*[@id="username"]') != []:
            print('\n\n')
            input('Realize o Login. Após Isso, Aperte Enter --> ')
            ...
            #browser.find_element_by_xpath('//*[@id="login_now_btn"]').click() #Clicando no btn login
            #time.sleep(10)
        
    except:
        pass

    ''' Acessando iframe e clicando no icone Roletas '''
    try:
    ...
    try:
        browser.find_element_by_xpath('//*[@id="category-navigator-roulette"]').click()
...
def checkSinalEnviado(lista_proximo_resultados, nome_cassino, roleta, resultado):
    ...
    while contador_cash <= int(qnt_gale):
        ...
        try:
            ...
            if lista_proximo_resultados[:3] != lista_resultados_sinal[:3]:
                ...
                if lista_resultados_sinal[0] in grupo_apostar[estrategia[3]]:
                    ...
                    try:
                        ...
                        for canal in canais:
                            try:
                                bot.reply_to(globals()[f'sinal_{canal}'], mensagem_green[19].replace('\n','').replace('[RESULTADO]', ' | '.join(resultados)), parse_mode='HTML')
                            except:
                                pass
    ...
    if contador_cash == int(qnt_gale)+1:
        print('LOSSS GALE2')
        placar_loss +=1
        ...
        try:
            ...
            for canal in canais:
                try:
                    bot.reply_to(globals()[f'sinal_{canal}'], mensagem_green[21].replace('\n','').replace('[LISTA_RESULTADOS]', ' | '.join(resultados)), parse_mode = 'HTML')
                except:
                    pass
