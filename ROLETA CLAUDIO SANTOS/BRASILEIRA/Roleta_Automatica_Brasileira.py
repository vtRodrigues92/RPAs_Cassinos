...
def inicio():
    ...
    lobby_cassinos = 'https://launcher.betfair.com/?gameId=live-rolet-brasileria-cptl&returnURL=https%3A%2F%2Fcasino.betfair.com%2Fpt-br%2Fp%2Fcassino-ao-vivo&launchProduct=gaming&RPBucket=gaming&mode=real&dataChannel=ecasino&switchedToPopup=true&_gl=1*8r73mn*_ga*Mjc1NTkyNTczLjE2ODQzNzgyNzk.*_ga_K0W97M6SNZ*MTY4NDM3ODI3OS4xLjEuMTY4NDM3ODMzNS40LjAuMA..'
...
def apostar_duas_casas(valor_aposta, *args):
    ...
    elif valor_aposta == 20:
        #CLICANDO NAS MOEDAS 20
        try:
