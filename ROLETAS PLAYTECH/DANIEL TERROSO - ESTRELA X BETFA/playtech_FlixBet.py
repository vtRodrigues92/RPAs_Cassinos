...
def nomeDosCassinos(nome_roleta):
    ...
    nome_dos_cassinos = [
        ...
        ('mega-fire-blaze-ruleta-espaa'),
        ('ruleta-clsica-francesa')
    ...
    cassinos = [
        ...
        ('Auto Roulette', 'https://estrelabet.com/pb/gameplay/auto-roulette-live/real-game'),
        ('Roleta Brasileira', 'https://estrelabet.com/pb/gameplay/roleta-brasileira-live/real-game'),
        ('American Roulette', 'https://estrelabet.com/pb/gameplay/american-roulette-live/real-game'),
        ('Mega Fire Blaze Roulette Live', 'https://estrelabet.com/pb/gameplay/mega-fire-blaze-roulette-live/real-game'),
        ('Speed Auto Roulette', 'https://estrelabet.com/pb/gameplay/speed-auto-roulette-live/real-game'),
        ('Speed Roulette', 'https://estrelabet.com/pb/gameplay/speed-roulette-live/real-game'),
        ('Prestige Roulette', 'https://estrelabet.com/pb/gameplay/prestige-roulette-live/real-game'),
        ('Roulette', 'https://estrelabet.com/pb/gameplay/roulette-live/real-game'),
        ('Roulette Italiana', 'https://estrelabet.com/pb/gameplay/roulette-italiana-live/real-game'),
        ('Bucharest Roulette', 'https://estrelabet.com/pb/gameplay/bucharest-roulette/real-game'),
        ('Turkish Roulette', 'https://estrelabet.com/pb/gameplay/turkish-roulette-live/real-game'),
        ('football-french-roulette', 'https://estrelabet.com/pb/gameplay/football-french-roulette-live/real-game'),
        ('hindi-roulette', 'https://estrelabet.com/pb/gameplay/hindi-roulette-live/real-game'),
        ('quantum-roulette-italiana', 'https://estrelabet.com/pb/gameplay/quantum-roulette-italiana-live/real-game'),
        ('quantum-auto-roulette', 'https://estrelabet.com/pb/gameplay/quantum-auto-roulette-live/real-game'),
        ('greek-roulette', 'https://estrelabet.com/pb/gameplay/greek-roulette-live/real-game'),
        ('mega-fire-blaze-ruleta-espaa', 'https://estrelabet.com/pb/gameplay/mega-fire-blaze-ruleta-espaa-live/real-game'),
        ('ruleta-clsica-francesa', 'https://estrelabet.com/pb/gameplay/ruleta-clsica-francesa-live/real-game'),
...
def inicio():
    ...
    lobby_cassinos = 'https://identitysso.betfair.com/view/login?product=launcher&redirectMethod=GET&url=https%3A%2F%2Flauncher.betfair.com%2F%3FgameId%3Dbetfair-live-roulette-cptl%26returnURL%3Dhttps%253A%252F%252Fcasino.betfair.com%252Fpt-br%252Fc%252Fpopular-no-brasil%26launchProduct%3Dgaming%26RPBucket%3Dgaming%26mode%3Dreal%26dataChannel%3Decasino%26switchedToPopup%3Dtrue&regurl='
...
def logarSite():
    ...
    #Lobby Cassinos Novo
    browser.get('https://casino-com-ngm.bfcdl.com/live/?gameId=live-roulette')
...
def coletarResultados(lista_roletas):
    ...
    while True:
        ...
        try:
            roletas = browser.find_elements_by_xpath('//*[@class="tables-grid__item--Jt0at"]')
            ...
            for roleta in roletas:
                ...
                if historico_roleta == [] and roletas == []:
                    browser.refresh()
                    print('refresh + logar site')
                    logarSite()
                
                elif historico_roleta == [] and roletas != []:
                    continue
...
def enviarAlertaTelegram(dicionario_roletas, nome_cassino, url_cassino, sequencia_minima, estrategia):
    ...
    ''' Lendo o arquivo txt config-mensagens '''
    txt = open("alerta.txt", "r", encoding="utf-8")
        ...
        for key, value in canais.items():
            try:
                globals()[f'alerta_{key}'] = bot.send_message(key, 
                                                                mensagem_alerta.replace('[NOME_CASSINO]', nome_cassino.title())
                                                                                ...
                                                                                .replace('[SITE_CASSINO]', url_cassino)
...
def enviarSinalTelegram(nome_cassino, url_cassino, sequencia_minima, estrategia):
    ...
    ''' Lendo o arquivo txt config-mensagens '''
    txt = open("sinal.txt", "r", encoding="utf-8")
...
def checkSinalEnviado(lista_proximo_resultados, nome_cassino, roleta):
            ...
            if lista_proximo_resultados[:3] != lista_resultados_sinal[:3]:
                ...
                if lista_resultados_sinal[0] in grupo_apostar[estrategia[3]] or lista_resultados_sinal[0] == '0' or lista_resultados_sinal[0] == '00':
                    ...
                    try:
                        ...
                        ''' Lendo o arquivo txt config-mensagens '''
                        txt = open("green.txt", "r", encoding="utf-8")
                        mensagem_green = txt.read()
                        
                        for key, value in canais.items():
                            try:
                                bot.reply_to(globals()[f'sinal_{key}'], mensagem_green.replace('[RESULTADO]', ' | '.join(resultados)), parse_mode='HTML')
                            except:
                                pass
    ...
    if contador_cash == 3:
        ...
        try:
            ...
            ''' Lendo o arquivo txt config-mensagens '''
            txt = open("red.txt", "r", encoding="utf-8")
            mensagem_red = txt.read()

            for key, value in canais.items():
                try:
                    bot.reply_to(globals()[f'sinal_{key}'], mensagem_red.replace('[LISTA_RESULTADOS]', ' | '.join(resultados)), parse_mode = 'HTML')
                except:
                    pass
...
def registrarTipoEstrategia(message_tipo_estrategia):
    ...
    if message_tipo_estrategia.text in ['ESTRATÉGIAS PADRÕES']:
        ...
        estrategias_padroes = (['repetição', '1ºcoluna', '6', '2ª/3ªcoluna'], 
                               ['repetição', '2ªcoluna', '6', '1º/3ªcoluna'], 
                               ['repetição', '3ªcoluna', '6', '1º/2ªcoluna'], 
                               ['repetição', '1ºduzia', '6', '2ª/3ªduzia'], 
                               ['repetição', '2ªduzia', '6', '1º/3ªduzia'], 
                               ['repetição', '3ªduzia', '6', '1º/2ªduzia'])
