        ...
        try:
            ...
            try:
                ...
                for roleta in roletas:
                    ...
                    ###SE RETORNOU NADA ANALISA A PROXIMA ROLETA
                    if url_cassino == None:
                        continue
...
def registrarTipoEstrategia(message_tipo_estrategia):
    ...
    if message_tipo_estrategia.text in ['ESTRATÉGIAS PADRÕES']:
        ...
        estrategias_padroes = ( ['repetição', '1ºcoluna', '5', '2ª/3ªcoluna'],
                                ['repetição', '2ªcoluna', '5', '1º/3ªcoluna'],
                                ['repetição', '3ªcoluna', '5', '1º/2ªcoluna'],
                                ['repetição', '1ºduzia', '5', '2ª/3ªduzia'],
                                ['repetição', '2ªduzia', '5', '1º/3ªduzia'],
                                ['repetição', '3ªduzia', '5', '1º/2ªduzia'],
                                )
