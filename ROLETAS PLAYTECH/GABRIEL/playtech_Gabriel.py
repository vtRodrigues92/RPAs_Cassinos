...
def apostas():
    ...
    opcoes_apostas = {
            ...
            'Números Irmãos':(['1', '2', '3', '4', '5', '6', '7', '14', '15', '22', '23', '24', '25', '32', '33', '34', '35', '36'], 
    ...
    while True:
        ...
        try:
            ...
            for roleta in roletas:
                ...
                # PRA ESSE USUARIO SÓ CONTINUA SE A ROLETA FOR BRASILEIRA
                    ...
                    try:
                        ...
                        if dicionario_roletas[nome_cassino][:3] != lista_proximo_resultados[:3]:
                            ...
                            if estrategia[0] == 'repetição':
                                ''' Verificando se o ultimo resultado da roleta está dentro da estratégia do Grupo B'''
                                if lista_proximo_resultados[0] in aposta_externa[estrategia[1]][1]:
                                    ...
                                    ''' Ou Verifica de o Ultimo Resultado Está no Grupo A - Continue até Sair um Numero do Grupo B'''
                                elif lista_proximo_resultados[0] in aposta_externa[estrategia[1]][0]:
                                    continue


                                    ''' Se Não Entrar em Nenhuma Condição, Apaga o Alerta'''
                                else:
...
def registrarTipoEstrategia(message_tipo_estrategia):
    ...
    if message_tipo_estrategia.text in ['ESTRATÉGIAS PADRÕES']:
        ...
        estrategias_padroes = (['repetição', 'Números Irmãos', '4'], 
                              ['repetição', 'Terminais 5 e Vizinhos', '4'],
                              ['repetição', '0 e Vizinhos', '4'], 
                              ['repetição', '5 e Vizinhos', '4'], 
                              ['repetição', '34 e Vizinhos', '4'], 
                              ['repetição', '31 e Vizinhos', '4'])
        ...
        message_aposta = bot.reply_to(message_tipo_estrategia, "🤖 Ok! Agora Escolha a Estratégia 👇", reply_markup=markup_apostas)
...
def registraSequenciaMinima(seq_minima):
    ...
    if seq_minima.text in ['◀ Voltar']:
        ...
        print(onde_apostar)
        bot.reply_to(seq_minima, "🤖 Estratégia Cadastrada ✅", reply_markup=markup)
