...
def pegar_evosessionid():
    #LOGIN
    URL = 'https://api-2.nexus-casino.io/auth/login'

    header = {
    'Content-Type': 'application/json',
    "Origin":"https://zero2.bet",
    "Referer":"https://zero2.bet/",
    "User-Agent":"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/123.0.0.0 Safari/537.36"
    }

    payload = '{"email":"jetxdemo@gmail.com","password":"123456","tenant":"65b165b93714b5640ba16f06"}'
    ...
    #REQUISIÇÃO1
    URL = 'https://api-2.nexus-casino.io/games/play'
...
def conectar_websocket(token):
    ...
    "Connection": "Upgrade",
    "Host": "eu-server-w99.ssgportal.com",
    "Origin": "https://eu-server-w99.ssgportal.com",
    "Pragma": "no-cache",
    "Sec-WebSocket-Extensions": "permessage-deflate; client_max_window_bits",
    "Sec-WebSocket-Key": "wEH3v5QTcxs6kVuvGaRrGQ==",
