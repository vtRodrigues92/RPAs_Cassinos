...
def velaMaluca():
    ...
    data = [
        ...
        ["🌐 <a href='https://mesk.bet/casino/?game=1'>Site do JetX</a>     "]
    ]
...
def raspagem():
    ...
    while True:
        ...
        try:
            if browser.find_elements_by_class_name('game-started') == []:
                ...
                while True:
                    try:
                        vela = browser.find_element_by_xpath('//*[@id="last100Spins"]/div[1]').text
            ...
            if browser.find_elements_by_class_name('game-started') == []:
                ...
                if float(vela) > float(estrategia[-2].strip('Xx')):
                    ...
                    try:
                        ...
                        if canal_adm != '':
                            bot.edit_message_text(table +"  \n============================== \n              WINNNN ✅ --- 🎯 "+ vela+"x", message_canal_adm.sender_chat.id, message_canal_adm.message_id, parse_mode='HTML', disable_web_page_preview=True)   
    ...
    if vela_maluca == 1:
        ...
        try:
            ...
            if canal_adm !='':
                bot.edit_message_text(table +"\n============================== \n                NÃO PAGOU 🥵👺   ", message_canal_adm.sender_chat.id, message_canal_adm.message_id, parse_mode='HTML', disable_web_page_preview=True)
