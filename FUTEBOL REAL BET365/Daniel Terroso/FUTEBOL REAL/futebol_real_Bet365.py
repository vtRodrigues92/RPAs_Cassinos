...
def auto_refresh():
    ...
    if horario_atual == horario_refresh:
        print('HORA DE RESETAR O PROGRAMA!!!!')
        inicio()
        logar_site()
        time.sleep(2)
...
def logar_site():
    ...
    c=0
    while c < 10:
        if browser.find_elements_by_xpath('//*[@class="iip-IntroductoryPopup_Cross"]') or\
            browser.find_elements_by_xpath('//*[@class="ovm-MediaIconContainer_Buttons "]') or\
            browser.find_elements_by_xpath('//*[@class="ovm-ClassificationBar_Contents "]'):
            break
        else:
            time.sleep(10)
            c+=1
            ...
            try:
                ...
                for jogo in jogos:
                    ...
                    try:
                        ...
                        print(e)
                        if 'no such element: Unable to locate element' in e.args[0]:
                            logar_site()
                        else:
                            continue
...
def pegar_link_jogo(time1, time2):
    ...
    try:
        ...
        for aposta in opcoes_aposta:
            ...
            if aposta.text == 'Escanteios/Cartões' or aposta.text == 'Corners/Cards' or aposta.text == 'Córners/Tarjetas' or aposta.text == 'Tiros de esquina/Tarjeta':
...
def enviarSinalTelegram(cg, appm, time):
    global table_sinal
            ...
            try:
                for key, value in canais.items():
                    try:
                        ...
                        globals()[f'sinal_{key}'] = bot.send_message(key, mensagem_sinal
                                                                    .replace('[TIME_REFERENCIA]', time)
                        ...
                        print(e)
                        #bot.send_message(5760892860, f"NÃO CONSEGUI ENVIAR SINAL PARA O CANAL {key}")
                        pass
