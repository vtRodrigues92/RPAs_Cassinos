...
def validar_horario_envio():
    ...
    horarios = [
        (dt.time(9, 0), dt.time(11, 0), "Lista de sinais da manhã:"),
        (dt.time(15, 0), dt.time(17, 0), "Lista de sinais da tarde:"),
        (dt.time(21, 00), dt.time(23, 0), "Lista de sinais da noite:")
    ]
