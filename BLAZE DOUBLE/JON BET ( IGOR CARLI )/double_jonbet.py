...
def coletar_dados():
    global api_jonbet_double

    api_jonbet_double = 'https://jon.bet/api/roulette_games/current'
    ...
    while True:      
            ...
            try:
                ...
                if sessao_ativa == True:
                    ...
                    resultado_roletta = requests.get(api_jonbet_double).json()
                    ...
                    if resultado_roletta['color'] == 1: cor = "verde"
            ...
            try:
                ...
                if value[0] != '' and value[1] != '':
                    table_sinal = mensagem_sinal\
                                    .replace('[COR]','🟢' if estrategia[-1] == 'verde' else '⚫' if estrategia[-1] == 'preto' else '⚪')\
                                    .replace('[SITE_PC]', value[1])\
                                    .replace('[SITE_MB]', value[1])\
                                    .replace('[SITE_CADASTRO]', value[0])\
...
def checkSinalEnviado(lista_resultados):
    ...
    while contador_cash <= int(gale):
        ...
        try:
            ...
            if lista_resultados[-1] == 'verde':
                resultado_valida_sinal.append('🟢')

            if lista_resultados[-1] == 'preto':
                resultado_valida_sinal.append('⚫')
            
            if lista_resultados[-1] == 'branco':
                resultado_valida_sinal.append('⚪')


            # VALIDANDO WIN OU LOSS
            if lista_resultados[-1] == estrategia[-1] or lista_resultados[-1] == 'branco':
...
def registrarTipoEstrategia(message_tipo_estrategia):
    ...
    if message_tipo_estrategia.text in ['ESTRATÉGIAS PADRÕES']:
        ...
        estrategias_padroes = ( ['verde','verde','verde','verde','preto'],
                                ['preto','preto','preto','preto','verde'], 
                                ['preto','verde','preto','verde','preto','verde','verde'], 
                                ['verde','preto','verde','preto','verde','preto','preto'] )
