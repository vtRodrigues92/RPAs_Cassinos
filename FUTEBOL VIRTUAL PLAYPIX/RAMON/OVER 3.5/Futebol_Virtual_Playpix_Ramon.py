    ...
    while True:
        ...
        while True:
            try:
                ...
                estrategia_over_tres_e_meio(lista_placares_somados)   #Lista de estrategia
...
def estrategia_over_tres_e_meio(lista_placares_somados):
    ...
    try:
        ...
        print('Validando a Estrategia OVER 3.5')
        print('Historico de Placares --> ', lista_placares_somados)

        ''' VALIDADOR DE ESTRATEGIA '''
        validador = validador_estrategia(lista_placares_somados, sequencia_minima_alerta)
            ...
            while True:
                ...
                try:
                    ...
                    if lista_placares_somados != lista_placares_somados_validacao:
                        ...
                        ''' VALIDA SE ENVIA SINAL OU APAGA O ALERTA '''
                        if lista_placares_somados_validacao[0] < 4:
                            ...
                            enviar_sinal(sinal, gale1, gale2, 'OVER 3.5')
    ...
    while contador_cash <= 2:
        ...
        try:
            ...
            if lista_placares_somados_validacao != lista_placares_formatados_sinal:
                ...
                # VALIDANDO WIN OU LOSS
                if lista_placares_formatados_sinal[0] >= 4:
                    ...
                    try:
                        ...
                        for key, value in canais.items():
                            try:
                                ...
                                bot.reply_to(globals()[f'sinal_{key}'], mensagem_green[33].replace('[RESULTADO]', ' | '.join(resultados)), parse_mode='HTML')
