...
class Bot(threading.Thread):
    ...
    def telegram_bot_sendtext(self, bot_message, bot):
        ...
        message = bot.send_message(self.destino, bot_message, parse_mode='HTML', reply_markup = reply_markup)
    ...
    def run(self):
        ...
        while True:
            ...
            bot.send_message(self.destino, self.mensagem_confirmacao)

            #POST PARA A API
            self.post_api('alert', self.mensagem_confirmacao)
            
            time.sleep(self.espera)

            texto = self.formatar_texto(self.mensagem_final)
