...
class PegarResultadosBacBo(threading.Thread):
    ...
    def conectar_websocket(self, evosessionid):
        ...
        try:
            ...
            "Connection": "Upgrade",
            "Cookie":f"EVOSESSIONID={evosessionid}; cdn=https://akam.egcdn.com; lang=bp; locale=pt-BR",
            "Host": "nesvembataross.evo-games.com",
            "Origin": "https://nesvembataross.evo-games.com",
            "Pragma": "no-cache",
            "Sec-WebSocket-Extensions": "permessage-deflate; client_max_window_bits",
            "Sec-WebSocket-Key": "JYH3qMqGHYbKjJwgURb43w==",
            ...
            URL = f'wss://nesvembataross.evo-games.com/public/bacbo/player/game/BacBo00000000001/socket?messageFormat=json&instance=6bxs0m-rfbci4g5dgy7gb5m-BacBo00000000001&tableConfig=&EVOSESSIONID={evosessionid}&client_version=6.20230720.71147.28123-68162491e2'
