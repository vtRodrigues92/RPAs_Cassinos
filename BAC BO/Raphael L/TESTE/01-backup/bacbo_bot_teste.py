...
class PegarResultadosBacBo(threading.Thread):
    ...
    def conectar_websocket(self, evosessionid):
        ...
        try:
            ...
            "Connection": "Upgrade",
            'Cookie':f'cdn=https://static.egcdn.com; lang=en; locale=en-GB; {evosessionid}',
            "Host": "live.wirebankers.com",
            "Origin": "https://live.wirebankers.com",
            "Pragma": "no-cache",
            "Sec-WebSocket-Extensions": "permessage-deflate; client_max_window_bits",
            "Sec-WebSocket-Key": "OYZQ2OSAsCpPqLjH3PBUaw==",
            ...
            URL = f'wss://live.wirebankers.com/public/bacbo/player/game/BacBo00000000001/socket?messageFormat=json&instance=oo457q-rkimpvrwoyoblpe3-BacBo00000000001&tableConfig=&{evosessionid}&client_version=6.20230912.132638.30931-17ca7a8530'
