...
def conectar_websocket(evosessionid):
    ...
    "Sec-WebSocket-Key": "pfc8iPNoU4Ns6LTuAJ75cg==",
    ...
    URL = f'wss://live.wirebankers.com/public/bacbo/player/game/BacBo00000000001/socket?messageFormat=json&instance=hhel3l-rkjz6lh3uz6rjl2l-BacBo00000000001&tableConfig=&{evosessionid}&client_version=6.20230913.72114.31027-6f08eb800b'
        ...
        for key, value in canais.items():
            try:
                ...
                table_sinal = mensagem_sinal[9].replace('\n','') + '\n' +\
                              ...
                              mensagem_sinal[11].replace('\n','').replace('[COR]','🟦PLAYER' if estrategia[-1] == 'Player' else '🟥BANKER' if estrategia[-1] == 'Banker' else '🟨TIE') + '\n' +\
