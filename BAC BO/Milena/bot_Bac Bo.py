...
class enviarAlertaTelegram(threading.Thread):
    def __init__(self, canal, mensagem, link_cadastro):
        self.canal = canal
...
def pegar_evosessionid():
    ...
    while True:
        ...
        try:
            ...
            payload = {"email":"milenadias@unigranrio.br",
                    "password":"Dessa1000@"}
...
def conectar_websocket(evosessionid):
    ...
    try:
        ...
        "Sec-WebSocket-Key": "tTk9d7GIo2LH5shxyYzVKg==",
        ...
        URL = f'wss://tmkybox.evo-games.com/public/bacbo/player/game/BacBo00000000001/socket?messageFormat=json&instance=wfq156-rt7gzpioarcamyfr-BacBo00000000001&tableConfig=&{evosessionid}&client_version=6.20240111.72607.37188-15165dd285'
    ...
    try:
        for key,value in canais.items():
            try:
                ...
                globals()[f'alerta_{key}'] = enviarAlertaTelegram(key, txt_alerta, value[0]).start()
    ...
    try:
        for key, value in canais.items():
            try:
                ...
                globals()[f'sinal_{key}'] = enviarSinalTelegram(key, msg_sinal, value[0]).start()
...
def mensagem_gale(contador_cash):
    ...
    with open('arquivos_txt/msg_gale.txt',"r", encoding="utf-8") as arquivo:
        ...
        try:
            ...
            for key,value in canais.items():
                ...
                try:
                    ...
                    txt_red = open('arquivos_txt/red.txt', 'r', encoding='UTF-8').read()
                    bot.reply_to(globals()[f'sinal_{key}'], txt_red, parse_mode='HTML')
