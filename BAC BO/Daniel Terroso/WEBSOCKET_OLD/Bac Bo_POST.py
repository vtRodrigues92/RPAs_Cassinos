...
def enviarSinalTelegram():
    ...
    payload = {
            ...
            'content': mensagem_sinal[9].replace('\n','') + '\n' +\
                       mensagem_sinal[11].replace('\n','').replace('[COR]','🟦PLAYER' if estrategia[-1] == 'P' else '🟥BANKER' if estrategia[-1] == 'B' else '🟨TIE') + '\n' +\
...
def cadastrarEstrategia(message):
    ...
    if contador_passagem == 0:
        ...
        message_estrategia = bot.reply_to(message, "🤖 Ok! Informe a Sequencia de Resultados que o Bot Terá que Identificar. *** O último Resultado será a da APOSTA ***  \n\n Ex: Player,Player,Player,Banker / Banker,Banker,Banker,Player", reply_markup=markup)
