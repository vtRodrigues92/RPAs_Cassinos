...
class enviarAlertaTelegram(threading.Thread):
    ...
    def run(self):
        ...
        try:
            ...
            botoes = [
                        [types.InlineKeyboardButton("🚨 JOGUE AQUI 🚨", url="https://go.aff.esportiva.bet/8ba468rr")],
...
def pegar_evosessionid():
    ...
    while True:
        ...
        try:
            ...
            payload = {"email":"tiagotg583@gmail.com",
                    "password":"Galo123#"}
...
def conectar_websocket(evosessionid):
    ...
    try:
        ...
        "Sec-WebSocket-Key": "dUC3TocNjxjIrKmHX37EPA==",
        ...
        URL = f'wss://tmkybox.evo-games.com/public/bacbo/player/game/BacBo00000000001/socket?messageFormat=json&instance=ewie6w-rtvuzouwcuydp3bj-BacBo00000000001&tableConfig=&{evosessionid}&client_version=6.20240103.201823.36846-493255c69b'
