...
def logar_site():
    ...
    try:
        ...
        while True:
            try:
                ...
                browser.find_element_by_xpath('/html/body/div[1]/div/main/nav/div[1]/div[2]/button').click()         #Clicando no botão Entrar
    ...
    try:
        ...
        browser.get(r"https://mesk.bet/casino/?gameid=6522")
        time.sleep(2)
