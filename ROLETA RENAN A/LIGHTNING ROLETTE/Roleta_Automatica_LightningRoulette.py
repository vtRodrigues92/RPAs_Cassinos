...
print()
print('                                #################################################################')
print('                                ################  BOT ROLETA LIGHTNING AUTO. ###################')
print('                                #################################################################')
...
def inicio():
    ...
    lobby_cassinos = 'https://launcher.betfair.com/?gameId=lightening-roulette-cev&returnURL=https%3A%2F%2Fcasino.betfair.com%2Fpt-br%2Fp%2Fcassino-ao-vivo&launchProduct=gaming&RPBucket=gaming&mode=real&dataChannel=ecasino'
...
def logarSite():
    ...
    while 0 < 10:
        try:
            iframe1 = browser.find_element_by_id('game-client-iframe-id')
            browser.switch_to_frame(iframe1)

            time.sleep(3)

            iframe2 = browser.find_element_by_xpath('/html/body/div[5]/div[2]/iframe')
                            ...
                            if estrategia[0] == 'repetição':
                                ...
                                if lista_proximo_resultados[0] in aposta_externa[estrategia[1]]:
                                    ...
                                    if '/' in estrategia[3]:
                                        ...
                                        aposta_protecao = '//*[@class="dddStandard-wrapper"]//*[name()="polygon"][@data-bet-spot-id="0"]'
                                        aposta_protecao_clicado = '//*[@class="dddStandard-wrapper"]//*[name()="polygon"][@data-bet-spot-id="0"]'
                                        ######## INSERINDO APOSTAS #######
                                        time.sleep(8)
...
def apostar_duas_casas(valor_aposta, *args):
    ...
    if valor_aposta == 1:
        ...
        try:
            ...
            #DAR 1 CLICK
            ActionChains(browser).move_to_element(browser.find_element_by_xpath(aposta_um)).click().perform()
            time.sleep(1)
            ActionChains(browser).move_to_element(browser.find_element_by_xpath(aposta_dois)).click().perform()
            time.sleep(1)
    ...
    if protecao_zero == 0.5:
        ...
        try:
            ...
            #CLICANDO NA APOSTA
            try:
                ActionChains(browser).move_to_element(browser.find_element_by_xpath(aposta_protecao)).click().perform()
            except:
                ActionChains(browser).move_to_element(browser.find_element_by_xpath(aposta_protecao_clicado)).click().perform()
            time.sleep(0.5)
    ...
    if valor_aposta == 1:
        ...
        try:
            ...
            if valor_aposta == 2:
                ...
                time.sleep(0.5)
                try:
                    ActionChains(browser).move_to_element(browser.find_element_by_xpath(aposta_um_clicado)).click().perform()
                except:
                    ActionChains(browser).move_to_element(browser.find_element_by_xpath(aposta_um)).click().perform()
                time.sleep(0.5)
...
def apostar_zero():
    ...
    aposta_zero = '//*[@class="dddStandard-wrapper"]//*[name()="polygon"][@data-bet-spot-id="0"]'
    aposta_zero_clicado = '//*[@class="dddStandard-wrapper"]//*[name()="polygon"][@data-bet-spot-id="0"]'
    ...
    #CLICANDO NA APOSTA
    ActionChains(browser).move_to_element(browser.find_element_by_xpath(aposta_zero)).click().perform()
    time.sleep(2)
    try:
        ActionChains(browser).move_to_element(browser.find_element_by_xpath(aposta_zero_clicado)).click().perform()
    except:
        ActionChains(browser).move_to_element(browser.find_element_by_xpath(aposta_zero)).click().perform()
    time.sleep(1)
...
def elemento_apostas(estrategia):
    ...
    elementos = {
            ...
            '1º/2ªcoluna': ['//*[@data-bet-spot-id="bottom2to1"]', 
                            '//*[@data-bet-spot-id="bottom2to1"]',
                            '//*[@data-bet-spot-id="middle2to1"]',
                            '//*[@data-bet-spot-id="middle2to1"]'
                            ],

            '2ª/3ªcoluna': ['//*[@data-bet-spot-id="middle2to1"]',
                            '//*[@data-bet-spot-id="middle2to1"]',
                            '//*[@data-bet-spot-id="top2to1"]',
                            '//*[@data-bet-spot-id="top2to1"]'
                            ],

            '1º/3ªcoluna': ['//*[@data-bet-spot-id="bottom2to1"]', 
                            '//*[@data-bet-spot-id="bottom2to1"]',
                            '//*[@data-bet-spot-id="top2to1"]',
                            '//*[@data-bet-spot-id="top2to1"]'
                            ],

            '1º/2ªduzia': ['//*[@data-bet-spot-id="1st12"]',
                           '//*[@data-bet-spot-id="1st12"]',
                           '//*[@data-bet-spot-id="2nd12"]',
                           '//*[@data-bet-spot-id="2nd12"]'
                           ],

            '2ª/3ªduzia': ['//*[@data-bet-spot-id="2nd12"]',
                           '//*[@data-bet-spot-id="2nd12"]',
                           '//*[@data-bet-spot-id="3rd12"]',
                           '//*[@data-bet-spot-id="3rd12"]'
                           ],

            '1º/3ªduzia': ['//*[@data-bet-spot-id="1st12"]',
                           '//*[@data-bet-spot-id="1st12"]',
                           '//*[@data-bet-spot-id="3rd12"]',
                           '//*[@data-bet-spot-id="3rd12"]'
                           ],
            ...
            'cor vermelho': ['//*[@data-bet-spot-id="red"]',
                             '//*[@data-bet-spot-id="red"]'
                             ],

            'cor preto': ['//*[@data-bet-spot-id="black"]',
                          '//*[@data-bet-spot-id="black"]'
                          ],
        
            'números baixos': ['//*[@data-bet-spot-id="from1to18"]',
                               '//*[@data-bet-spot-id="from1to18"]'
                               ],

            'números altos': ['//*[@data-bet-spot-id="from19to36"]',
...
def enviar_saldo_atual(message):
    ...
    while True:
        try:
            ...
            saldo_atual = browser.find_element_by_xpath('//*[@class="amount--bb99f"]').text.split(' ')[1][:-1]
