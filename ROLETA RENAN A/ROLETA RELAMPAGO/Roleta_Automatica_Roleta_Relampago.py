...
print()
print('                                #################################################################')
print('                                ################  BOT ROLETA RELÂMPAGO AUTO. ###################')
print('                                #################################################################')
...
def inicio():
    ...
    lobby_cassinos = 'https://launcher.betfair.com/?gameId=live-lr-brazil-cev&returnURL=https%3A%2F%2Fcasino.betfair.com%2Fpt-br%2Fp%2Fcassino-ao-vivo&launchProduct=gaming&RPBucket=gaming&mode=real&dataChannel=ecasino'
