...
def logar_site():
    ...
    #logger = logging.getLogger()
    browser.get(r"https://pagbet.com/")
    try:
    ...
    try:
        # cookies
        browser.find_element_by_id('cookiescript_reject').click()
    except:
        pass
    ...
    try:
        ...
        while True:
            try:
                ...
                browser.find_element_by_name('user_name').send_keys(usuario) #Inserindo login
                browser.find_element_by_name('password').send_keys(senha)    #Inserindo senha
                browser.find_element_by_xpath('//*[@class="ml-2 btn-orange-flat login-button"]').click()  #Clicando no btn login
                time.sleep(5)
                break
        ...
        t3 = 0
        while t3 < 20:
            if browser.find_elements_by_xpath('//*[@class="balance"]'):
                break
            else:
                t3+=1
    ...
    try:
        ...
        browser.get(r"https://pagbet.com/aviator")
...
def acessar_iframe():
    ...
    while c <10:
        try:
            ...
            iframe = browser.find_element_by_xpath('//*[@class="flex-grow bg-black-50"]')
