...
def logar_site():
    ...
    #logger = logging.getLogger()
    browser.get(r"https://www.forra.bet/sports/home")
    ...
    try:
        ...
        while True:
            try:
                ...
                try:
                    browser.find_element_by_xpath('/html/body/section[2]/div/div/div[3]/a[2]').click()
                except:
                    pass
                try:

                    browser.find_element_by_xpath('/html/body/div[3]/div/div/div[2]/form/div/input[1]').send_keys(usuario) #Inserindo login
                    browser.find_element_by_xpath('/html/body/div[3]/div/div/div[2]/form/div/input[2]').send_keys(senha) #Inserindo senha
                    browser.find_element_by_xpath('/html/body/div[3]/div/div/div[2]/form/button').click() #Clicando no btn login
                    break
        ...
        t3 = 0
        while t3 < 20:
            if browser.find_elements_by_xpath('/html/body/section[2]/div/div/div[3]/a/span'):
                break
            else:
                t3+=1
    ...
    try:
        ...
        browser.get(r"https://www.forra.bet/sports/play-casino2?gameid=6109")
        time.sleep(5)

        #tela_cheia = browser.find_element_by_xpath('//*[@id="__layout"]/main/div[3]/div/div/div/div/div[3]/div/a').get_attribute('href')
    ...
    while True:
        ...
        while True:
            try:
                ...
                historico_velas = browser.find_elements_by_xpath('/html/body/app-root/app-game/div/div[1]/div[2]/div/div[2]/div[1]/app-stats-widget/div/div[1]/div/app-payout-item')
        ...
        for estrategia in estrategias:
            ...
            if validador.count(True) == int(sequencia_minima_alerta):
                ...
                while True:
                    ...
                    numeros_recentes_validacao = browser.find_elements_by_xpath('/html/body/app-root/app-game/div/div[1]/div[2]/div/div[2]/div[1]/app-stats-widget/div/div[1]/div/app-payout-item')
                    ...
                    if '' in lista_proximo_resultados or lista_proximo_resultados == []:
                        logar_site()
                        continue
...
def checar_sinal_enviado(lista_proximo_resultados, estrategia):
    ...
    while contador_cash <= 2:
        ...
        try:
            ...
            if '' in lista_resultados_sinal or lista_resultados_sinal == []:
                logar_site()
                continue
    ...
    if contador_cash > 2:
        ...
        try:
            ...
            for key, value in canais.items():
                try:
                    bot.reply_to(globals()[f'sinal_{key}'], mensagem_green[34].replace('\n','').replace('[LISTA_RESULTADOS]', ' | '.join(resultados)), parse_mode = 'HTML')
                except:
                    pass
...
def start(message):
    ...
    if str(message.chat.id) in ids:
        ...
        message_opcoes = bot.reply_to(message, "🤖 Bot Aviator FORRA.BET Iniciado! ✅ Escolha uma opção 👇",
                                reply_markup=markup)
