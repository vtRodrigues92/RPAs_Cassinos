...
def logar_site():
    ...
    try:
        ...
        t3 = 0
        while t3 < 20:
            if browser.find_elements_by_xpath('//*[@class="profile-content mr-20 balance-dropdown"]'):
                break
            else:
                t3+=1
    ...
    try:
        ...
        browser.get(r"https://mesk.bet/casino?gameid=8967")
        time.sleep(15)

        tela_cheia = browser.find_element_by_xpath('//*[@id="egamings_container"]/iframe').get_attribute('src')
