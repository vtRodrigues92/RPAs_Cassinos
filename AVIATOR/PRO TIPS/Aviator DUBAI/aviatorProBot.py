...
#            cor = 'azul'
#    
#        if float(vela_atual) >=2 and float(vela_atual) < 10 :
#            cor = 'roxo'
#
#        if float(vela_atual) >= 10:
#            cor = 'rosa'
#        
#       
#
...
def logar_site():
    ...
    try:
        ...
        browser.find_element_by_id('email').send_keys('dubaitipsft@gmail.com')
...
def enviar_sinal(vela_atual):
    ...
    data = [
        ['⏰ ENTRAR APÓS O RESULTADO '+ vela_atual +'x'                  ],
        ['🔰 FAZER ATÉ ' + estrategia[-1] + ' PROTEÇÕES' if int(estrategia[-1]) > 0 else '🔰 FAZER NENHUMA PROTEÇÃO'],
        ["🌐 <a href='https://m.esportesdasorte.com/ptb/games/casino'>Site do Aviator</a>     "],
        [''],
