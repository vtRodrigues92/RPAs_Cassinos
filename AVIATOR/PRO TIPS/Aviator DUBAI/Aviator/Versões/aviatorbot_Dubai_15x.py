...
def inicio():
    ...
    logger = logging.getLogger()
    browser.get(r"https://sgame-aviator.gamecontentprovider.com/?user=42333&token=d3e5485b-03ed-4585-9a93-8ba6f53974d4&lang=en&currency=BRL&return_url=&operator=1627")
