    ...
    try:
        ...
        for estrategia in lista_estrategias:
            ...
            if validador.count('true') == int(sequencia_minima)-1:
                ...
                print('ENVIAR ALERTA')
                enviarAlertaTelegram(dicionario_roletas, nome_cassino, sequencia_minima, estrategia, nome_fornecedor, site_cassino_desktop, site_cassino_mobile)
                time.sleep(1)
                        ...
                        if lista_resultados[:int(sequencia_minima)] != lista_proximo_resultados[:int(sequencia_minima)]:
                            ...
                            if estrategia[0] == 'repetição':
                                ...
                                if lista_proximo_resultados[0] in aposta_externa[estrategia[1]]:
                                    ...
                                    enviarSinalTelegram(nome_cassino, sequencia_minima, estrategia, nome_fornecedor, lista_proximo_resultados, site_cassino_desktop, site_cassino_mobile)
                                    print('=' * 220)
                            ...
                            if estrategia[0] == 'ausência':
                                ...
                                if lista_proximo_resultados[0] not in aposta_externa[estrategia[1]]:
                                    dicionario_roletas[nome_cassino] = lista_proximo_resultados
                                    print('ENVIANDO SINAL TELEGRAM')
                                    enviarSinalTelegram(nome_cassino, sequencia_minima, estrategia, nome_fornecedor, site_cassino_desktop, site_cassino_mobile)
                                    print('=' * 220)
                                    checkSinalEnviado(lista_proximo_resultados, nome_cassino)
                                    break
...
def enviarAlertaTelegram(dicionario_roletas, nome_cassino, sequencia_minima, estrategia, nome_fornecedor, site_cassino_desktop, site_cassino_mobile):
    global contador_passagem
    ...
    table_alerta = mensagem_alerta[0].replace('\n','') + '\n\n' +\
                   ...
                   mensagem_alerta[10].replace('\n','').replace('[SITE_DESKTOP]', site_cassino_desktop).replace('[SITE_MOBILE]', site_cassino_mobile)+ '\n\n\n' +\
                   mensagem_alerta[14].replace('\n','')
...
def enviarSinalTelegram(nome_cassino, sequencia_minima, estrategia, nome_fornecedor, lista_proximo_resultados, site_cassino_desktop, site_cassino_mobile):
    global table_sinal
    ...
    ''' Mensagem '''
    table_sinal = mensagem_sinal[21].replace('\n','') + '\n\n' +\
                  ...
                  mensagem_sinal[33].replace('\n','').replace('[SITE_DESKTOP]', site_cassino_desktop).replace('[SITE_MOBILE]', site_cassino_mobile)+ '\n\n' +\
                  mensagem_sinal[35].replace('\n','')
...
def checkSinalEnviado(lista_proximo_resultados, nome_cassino):
    ...
    while contador_cash <= 2:
        ...
        try:
            ...
            ''' Valida se a lista de resultados atual é a mesma da lista definida antes de Validar o win'''
                ...
                if lista_proximo_resultados[:int(sequencia_minima)] != lista_resultados_sinal[:int(sequencia_minima)]:
                    ...
                    if lista_resultados_sinal[0] in grupo_apostar[estrategia[3]] or lista_resultados_sinal[0] == '0' or lista_resultados_sinal[0] == '00':
                        ...
                        try:
                            ...
                            for canal in canais:
                                try:
                                    bot.reply_to(globals()[f'sinal_{canal}'], mensagem_green[40].replace('\n','').replace('[RESULTADO]', ' | '.join(resultados)), parse_mode='HTML')
                                except:
                                    pass
    ...
    if contador_cash == 3:
        ...
        try:
            ...
            for canal in canais:
                try:
                    bot.reply_to(globals()[f'sinal_{canal}'], mensagem_green[42].replace('\n','').replace('[LISTA_RESULTADOS]', ' | '.join(resultados)), parse_mode = 'HTML')
                except:
                    pass
