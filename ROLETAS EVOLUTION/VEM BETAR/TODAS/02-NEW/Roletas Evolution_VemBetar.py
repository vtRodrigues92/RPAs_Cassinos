...
print()
print('                                #################################################################')
print('                                #############   BOT ROLETAS EVOLUTION VEM BETAR  ################')
print('                                #################################################################')
...
def link_cassino(nome_cassino):
    ...
    roletas_e_links = [
        ...
        ('Auto-Roulette', 'https://vembetar.com/ptb/games/livecasino/detail/normal/18225/evol_48z5pjps3ntvqc1b_BRL','https://m.vembetar.com/ptb/games/livecasino/detail/18225/evol_48z5pjps3ntvqc1b_BRL'),
        ('Auto-Roulette VIP', 'https://vembetar.com/ptb/games/livecasino/detail/normal/18451/evol_01rb77cq1gtenhmo_BRL', 'https://m.vembetar.com/ptb/games/livecasino/detail/18451/evol_01rb77cq1gtenhmo_BRL'),
        ('Roulette', 'https://vembetar.com/ptb/games/livecasino/detail/normal/18111/evol_vctlz20yfnmp1ylr_BRL', 'https://m.vembetar.com/ptb/games/livecasino/detail/18111/evol_vctlz20yfnmp1ylr_BRL'),
        ('Brazilian Lightning Roulette', 'https://vembetar.com/ptb/games/livecasino/detail/normal/20801/evol_PorROULigh000001_BRL', 'https://m.vembetar.com/ptb/games/livecasino/detail/20801/evol_PorROULigh000001_BRL'),
        ('VIP Roulette', 'https://vembetar.com/ptb/games/livecasino/detail/normal/18410/evol_qjr54svxz2pthgbt_BRL', 'https://m.vembetar.com/ptb/games/livecasino/detail/18410/evol_qjr54svxz2pthgbt_BRL'),
        ('Speed Auto Roulette', 'https://vembetar.com/ptb/games/livecasino/detail/normal/18294/evol_SpeedAutoRo00001_BRL', 'https://m.vembetar.com/ptb/games/livecasino/detail/18294/evol_SpeedAutoRo00001_BRL'),
        ('Lightning Roulette', 'https://vembetar.com/ptb/games/livecasino/detail/normal/18091/evol_LightningTable01_BRL', 'https://m.vembetar.com/ptb/games/livecasino/detail/18091/evol_LightningTable01_BRL'),
        ('Speed Roulette', 'https://vembetar.com/ptb/games/livecasino/detail/normal/18372/evol_lkcbrbdckjxajdol_BRL', 'https://m.vembetar.com/ptb/games/livecasino/detail/18372/evol_lkcbrbdckjxajdol_BRL'),
        ('American Roulette', 'https://vembetar.com/ptb/games/livecasino/detail/normal/18493/evol_AmericanTable001_BRL', 'https://m.vembetar.com/ptb/games/livecasino/detail/18493/evol_AmericanTable001_BRL'),
        ('Immersive Roulette', 'https://vembetar.com/ptb/games/livecasino/detail/normal/18503/evol_7x0b1tgh7agmf6hv_BRL', 'https://m.vembetar.com/ptb/games/livecasino/detail/18503/evol_7x0b1tgh7agmf6hv_BRL'),
        ('Lightning Roulette', 'https://vembetar.com/ptb/games/livecasino/detail/normal/18091/evol_LightningTable01_BRL', 'https://m.vembetar.com/ptb/games/livecasino/detail/18091/evol_LightningTable01_BRL'),
        ('XXXtreme Lightning Roulette', 'https://vembetar.com/ptb/games/livecasino/detail/normal/19884/evol_XxxtremeLigh0001_BRL', 'https://m.vembetar.com/ptb/games/livecasino/detail/normal/19884/evol_XxxtremeLigh0001_BRL')
...
def logarSite():
    ...
    try:
        browser.get('https://www.vembetar.com/prejogo/')
    ...
    while True:
        try:
                ...
                browser.find_element_by_xpath('//*[@class="btn_general login_btn"]').click()
               
                ''' inserindo credenciais '''
                browser.find_element_by_xpath('//*[@class="login_user login_txt"]').send_keys(usuario)
                time.sleep(1)
                browser.find_element_by_xpath('//*[@class="login_pass login_txt password_eye_field"]').send_keys(senha)
                time.sleep(1)
                browser.find_element_by_xpath('//*[@class="login_btn"]').click()
                break
    ...
    try:
        ...
        browser.get('https://www.vembetar.com/casino/game/4809-lightning-roulette')
        time.sleep(15)
    ...
    try:
        ...
        browser.get('https://belloatech.evo-games.com/frontend/evo/r2/#category=roulette&game=roulette')
        time.sleep(10)
...
def enviarAlertaTelegram(dicionario_roletas, nome_cassino, sequencia_minima, estrategia):
    ...
    payload = {
            ...
            'link_game_bet':[link_roleta_mobile]
    }
...
def start(message):
    ...
    if str(message.chat.id) in ids:
        ...
        message_opcoes = bot.reply_to(message, "🤖 Bot de Roletas Evolution Vem betar Iniciado! ✅ Escolha uma opção 👇",
                                    reply_markup=markup)
...
def registrarTipoEstrategia(message_tipo_estrategia):
    ...
    if message_tipo_estrategia.text in ['ESTRATÉGIAS PADRÕES']:
        ...
        estrategias_padroes = (['repetição', '1ª coluna', '4', '2ª/3ª coluna'], 
                               ['repetição', '2ª coluna', '4', '1ª/3ª coluna'], 
                               ['repetição', '3ª coluna', '4', '1ª/2ª coluna'], 
                               ['repetição', '1ª duzia', '4', '2ª/3ª duzia'], 
                               ['repetição', '2ª duzia', '4', '1ª/3ª duzia'], 
                               ['repetição', '3ª duzia', '4', '1ª/2ª duzia'])
