        ...
        try:
            ...
            for roleta in roletas:
                ...
                try:
                    ...
                    link_roleta = link_cassino(nome_cassino)
            ...
            try:
                ...
                globals()[f'sinal_{key}'] = bot.send_message(key, 
                                                               message_sinal.replace('[APOSTA]', estrategia[3].upper())
                                                                          ...
                                                                          .replace('[LINK_GAME]', link_roleta)
                                                                          .replace('[ESTRATEGIA]', estrategia[0].title()+' de '+estrategia[1].title())
                                                                          .replace('[ULTIMOS_RESULTADOS]', ' | '.join(dicionario_roletas[nome_cassino]))
                    ...
                    try:
                        ...
                        for key, value in canais.items():
                            try:
                                ...
                                bot.send_message(key, message_green.replace('[RESULTADO]', '('+' | '.join(resultados)+')')\
                                                                          .replace('[NOME_CASSINO]', nome_cassino.title())
                                                                          .replace('[LINK_GAME]', link_roleta)
                                                                          .replace('[ESTRATEGIA]', estrategia[0].title()+' de '+estrategia[1].title()),
                                                                            parse_mode='HTML')
        ...
        try:
            ...
            for key, value in canais.items():
                try:
                    ...
                    bot.send_message(key, message_red.replace('[RESULTADO]', ' | '.join(resultados))\
                                                                          .replace('[NOME_CASSINO]', nome_cassino.title())
                                                                          .replace('[LINK_GAME]', link_roleta)
                                                                          .replace('[ESTRATEGIA]', estrategia[0].title()+' de '+estrategia[1].title()),
                                                                            parse_mode='HTML')
