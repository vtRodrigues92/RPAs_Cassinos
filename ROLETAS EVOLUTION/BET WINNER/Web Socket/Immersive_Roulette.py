...
def pegar_evosessionid():
    ...
    while True:
        ...
        try:
            ...
            "Origin":"https://kwbet.bet",
            "Referer":"https://kwbet.bet/",
            "User-Agent":"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/125.0.0.0 Safari/537.36",
            }

            payload = {"username":"Twik.live@gmail.com",
                       "password":"Bet123!",
                       "googleId":"",
                       "googleIdToken":"",
                       "cookie":""}
            ...
            token_usuario = response.json()['results']['token']
            token_cassino = response.json()['results']['tokenCassino']
            ...
            #### ENTRANDO NO GAME
            #REQUISIÇÃO1
            URL = f'https://central.kwbet.bet/casino/games/url?token={token_cassino}&tokenUsuario={token_usuario}&symbol=evo-oss-xs-immersive-roulette&language=pt&playMode=REAL&cashierUr=https%3A%2F%2Fkwbet.bet%2Fclientes%2Fdeposito&lobbyUrl=https%3A%2F%2Fkwbet.bet%2Fcasino&fornecedor=evolution&isMobile=0&plataforma=pc'
            ...
            gameURL = json.loads(response.content)['gameURL']
            print(gameURL)

            #REQUISIÇÃO2
            response = requests.get(gameURL)

            gameURL_2 = response.text.split('iframe src="')[1].split('" frameborder=')[0]
            print(gameURL_2)

            #REQUISIÇÃO3
            headers = {
                "Accept":"text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7",
                "Cookie":"cdn=https://static.egcdn.com; lang=bp; locale=pt-BR; EVOSESSIONID=r66fd3au7hrbez7cr66fmhou2io2x7kr237330c5066ac3392c0b010c993d109e2d706e94d44eb0ad",
                "Referer":"https://api.salsagator.com/",
                "User-Agent":"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/116.0.0.0 Safari/537.36"
            }

            response = requests.get(gameURL_2, headers=headers, allow_redirects=False, verify=False)
...
def conectar_websocket(evosessionid):
    ...
    try:
        ...
        "Host": "betmotionmx.evo-games.com",
        "Origin": "https://betmotionmx.evo-games.com",
        "Pragma": "no-cache",
        "Sec-WebSocket-Extensions": "permessage-deflate; client_max_window_bits",
        "Sec-WebSocket-Key": "guZ7FW/bbpDwPOPfkJYTdw==",
        ...
        URL = f'wss://betmotionmx.evo-games.com/public/roulette/player/game/7x0b1tgh7agmf6hv/socket?messageFormat=json&instance=x5ibuu-r7qgvexzf3bqztxw-7x0b1tgh7agmf6hv&tableConfig=&{evosessionid}&client_version=6.20240529.62956.41908-e56d05011a'
